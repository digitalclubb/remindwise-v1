...
export type AddReminderMutation = {
	...
	insertIntoReminderCollection?: {
		__typename?: 'ReminderInsertResponse';
		affectedCount: number;
		records: Array<{ __typename?: 'Reminder'; id: string }>;
	} | null;
};
...
export type UpdateSettingsMutation = {
	...
	updateSettingsCollection: {
		__typename?: 'SettingsUpdateResponse';
		affectedCount: number;
		records: Array<{ __typename?: 'Settings'; id: string }>;
	};
};
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'insertIntoCategoryCollection' },
						arguments: [
							{
								kind: 'Argument',
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'insertIntoReminderCollection' },
						arguments: [
							{
								kind: 'Argument',
								name: { kind: 'Name', value: 'objects' },
									...
									values: [
										{
											...
											fields: [
												...
												{
													kind: 'ObjectField',
													name: { kind: 'Name', value: 'auto_renewal' },
													value: {
														kind: 'Variable',
														name: { kind: 'Name', value: 'autoRenewal' },
													},
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'deleteFromCategoryCollection' },
						arguments: [
							{
								kind: 'Argument',
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'deleteFromReminderCollection' },
						arguments: [
							{
								kind: 'Argument',
								name: { kind: 'Name', value: 'filter' },
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'updateCategoryCollection' },
						arguments: [
							{
								kind: 'Argument',
								name: { kind: 'Name', value: 'filter' },
	...
	definitions: [
		{
			...
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						name: { kind: 'Name', value: 'updateReminderCollection' },
						arguments: [
							{
								kind: 'Argument',
								name: { kind: 'Name', value: 'filter' },
	...
	definitions: [
		{
			...
			variableDefinitions: [
				...
				},
				{
					...
					variable: {
						kind: 'Variable',
						name: { kind: 'Name', value: 'noticePeriod' },
					},
					type: { kind: 'NamedType', name: { kind: 'Name', value: 'Int' } },
				},
				{
							...
							},
							{
								...
								value: {
									...
									fields: [
										...
										{
											kind: 'ObjectField',
											name: { kind: 'Name', value: 'notice_period' },
											value: {
												kind: 'Variable',
												name: { kind: 'Name', value: 'noticePeriod' },
											},
	...
	definitions: [
		{
			...
			directives: [
				{ kind: 'Directive', name: { kind: 'Name', value: 'load' } },
			],
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
...
export const GetHistoryDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'GetHistory' },
			directives: [
				{ kind: 'Directive', name: { kind: 'Name', value: 'load' } },
			],
			selectionSet: {
				...
				selections: [
					{
						kind: 'Field',
						alias: { kind: 'Name', value: 'history' },
						name: { kind: 'Name', value: 'historyCollection' },
						arguments: [
							{
								kind: 'Argument',
											...
											fields: [
												{
													...
													value: { kind: 'EnumValue', value: 'AscNullsFirst' },
												},
											],
										},
									],
...
} as unknown as DocumentNode<GetHistoryQuery, GetHistoryQueryVariables>;
				...
				selections: [
					{
						kind: 'Field',
						alias: { kind: 'Name', value: 'reminders' },
						name: { kind: 'Name', value: 'reminderCollection' },
						arguments: [
							{
								kind: 'Argument',
								name: { kind: 'Name', value: 'filter' },
